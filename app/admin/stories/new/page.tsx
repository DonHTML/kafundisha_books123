                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black uppercase tracking-tighter text-zinc-900">
                            Create <span className="text-primary italic">Story</span>
                        </h1>
                        <p className="text-sm font-bold text-zinc-400 uppercase tracking-widest mt-1">
                            Add a new animation or folktale to the media lab
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSave} className="grid gap-8 lg:grid-cols-3">
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-200 shadow-sm space-y-8">
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        required
                                        type="text"
                                        placeholder="e.g. Kalulu and the Stubborn Hippo"
                            ...
                            <div>
                                <label className="block text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-3 ml-1">YouTube Video ID (Optional)</label>
                                <div className="relative">
                                    <div className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-400">
                                        <YoutubeIcon size={18} />
                                    </div>
                                    <input
                                        type="text"
                                        placeholder="e.g. lW0D3IG2UZ8"
                                        value={formData.youtube_id}
                                        onChange={(e) => setFormData({ ...formData, youtube_id: e.target.value })}
                                        className="w-full rounded-2xl bg-zinc-50 border-none pl-14 pr-6 py-4 text-sm font-bold focus:ring-2 focus:ring-primary/20 transition-all h-[60px]"
                                    />
                                </div>
                                <p className="text-[10px] font-bold text-zinc-400 mt-2 ml-1">Paste only the ID (Characters after v= in URL)</p>
                            </div>

                            <div>
                                <label className="block text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-3 ml-1">Short Description</label>
                                <textarea
                                    required
                                    rows={4}
                                    placeholder="Write a brief overview of the story or folktale..."
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <label className="flex flex-col items-center justify-center gap-3 border-2 border-dashed border-zinc-200 rounded-[2rem] p-10 bg-zinc-50/50 hover:bg-zinc-50 hover:border-primary/30 transition-all cursor-pointer group">
                                    ...
                                    <div className="text-center">
                                        <p className="text-xs font-black uppercase tracking-widest text-zinc-900">{uploading ? "Uploading..." : "Upload cover file"}</p>
                                ...
                                <div className="space-y-4">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400 text-center">Or use URL</p>
                                    <div className="relative">
                                        <div className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-400">
                                            <ImageIcon size={18} />
                                        </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-10 rounded-[2.5rem] border border-zinc-200 shadow-sm space-y-8">
                        ...
                        <div>
                            <label className="block text-[10px] font-black uppercase tracking-widest text-zinc-400 mb-3 ml-1">Content Type</label>
                            <div className="relative">
                                <div className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-400 pointer-events-none">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-[10px] font-bold text-zinc-400 text-center uppercase tracking-widest px-8">
                            This will make the story available in the Media Lab for all users.
                        </p>
                    </div>
                </div>
            </form>
